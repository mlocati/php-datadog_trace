...
static void dd_uhook(INTERNAL_FUNCTION_PARAMETERS, bool tracing, bool method) {
    ...
    zai_string_view class_str = method ? (zai_string_view)ZAI_STRING_FROM_ZSTR(class_name) : (zai_string_view)ZAI_STRING_EMPTY;
...
PHP_FUNCTION(dd_untrace) {
    ...
    zai_string_view class_str = class_name ? (zai_string_view)ZAI_STRING_FROM_ZSTR(class_name) : (zai_string_view)ZAI_STRING_EMPTY;
    zai_string_view func_str = ZAI_STRING_FROM_ZSTR(method_name);
